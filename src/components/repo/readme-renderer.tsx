  ...
  const components: Components = {
    img: ({ src, alt, ...props }) => (
      ...
      <img
        ...
        src={
          typeof src === "string"
            ? resolveGitHubUrl(src, repoFullName, defaultBranch)
            : undefined
        }
        alt={alt ?? ""}
      />
    ...
    a: ({ href, children, ...props }) => (
      <a
        {...props}
        href={
          href && isRelativeUrl(href)
            ? `https://github.com/${repoFullName}/blob/${defaultBranch}/${href.replace(/^\.\//, "")}`
            : href
        }
        target="_blank"
